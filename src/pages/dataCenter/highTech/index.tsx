        ...
        <ProTable<ColumnType & { indexNum: number }>
            ...
            let apiParams =
              userInfo.loginRole === 2
                ...
                : {
                    ...
                    accreditationAgency: params.accreditationAgency,
                  };
            try {
              const res: SearchHighTechType = await getHighTech[
                userInfo.loginRole
              ](apiParams);
              console.log(res, 'res');
          ...
          editable={{
            ...
            onSave: async (key, row, originRow) => {
              ...
              try {
                const data = await updateHighTech[userInfo.loginRole](row);
            ...
            onDelete: async (key, row) => {
              try {
                ...
                const data = await deleteHighTech[userInfo.loginRole](
                  key.toString(),
                );
                if (typeof data === 'object' && 'code' in data) {
                  message.error('删除失败');
